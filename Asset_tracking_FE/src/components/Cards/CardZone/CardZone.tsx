...
function CardZone({ socket, currentAssetMonitor }: Props) {
  var zones: Zone[] = []
  ...
  console.log('DatacoordinatesRender : ', datacoordinatesRender)
  ...
  const handleClickShade = (zone: Zone, polygon: google.maps.Polygon) => {
    ...
    if (zone.rules) {
      console.log('---zone: ', zone.rules)
      setZoneRule(optionsType[+zone.rules])
    }
  ...
  console.log('111', currentAssetMonitor)
    ...
    <div className='relative overflow-hidden rounded bg-white'>
      ...
      <div className='overflow-hidden'>
        ...
        >
          ...
          {/* Polyline Dot*/}
          <Polyline
            path={createDashedPolyline2(datacoordinatesRender)}
